...
public class ValidateCodeUtil {
	...
	public ByteArrayInputStream getRandcode() {
        ...
        g.setColor(getRandColor(80, 250));//������ɫ
        g.fillRect(0, 0, width, height);//��䱳��
        g.setColor(getRandColor(100, 130));//������ɫ
        ...
        ActionContext.getContext().getSession().put(RANDOMCODEKEY, randomString);
        System.out.println(randomString);
        g.dispose();
        try {
            return convertImageToStream(image);//���ڴ��е�ͼƬͨ��������ʽ������ͻ���
        } catch (Exception e) {
            e.printStackTrace();
        }
		return null;
